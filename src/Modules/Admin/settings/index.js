                              ...
                              <RadioGroup.Option
                                ...
                                className={({ active, checked }) =>
                                  classNames(
                                    ...
                                    'flex items-center justify-center rounded-3xl py-2 w-min px-6  cursor-pointer text-sm font-semibold uppercase '
                                  )
                                }
                              ...
                              <RadioGroup.Option
                                ...
                                className={({ active, checked }) =>
                                  classNames(
                                    ...
                                    'flex items-center justify-center rounded-3xl py-2 w-min px-6  text-sm cursor-pointer font-semibold uppercase '
                                  )
                                }
                              // disabled={!option.inStock}
                              >
                              ...
                              <RadioGroup.Option
                                ...
                                className={({ active, checked }) =>
                                  classNames(
                                    ...
                                    'flex items-center justify-center w-min rounded-3xl py-2 px-6  text-xs cursor-pointer font-semibold uppercase '
                                  )
                                }
                              // disabled={!option.inStock}
                              >
